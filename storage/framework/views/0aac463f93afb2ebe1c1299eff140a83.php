...
<!--[if BLOCK]><![endif]--><?php if($type == 'submit' || $type == 'button'): ?>
    <button <?php echo e($attributes->merge(['type' => $type, 'class' => 'inline-flex items-center px-4 py-2 rounded-md font-semibold text-xs uppercase tracking-widest disabled:opacity-25 transition ease-in-out duration-150 ' . $classes])); ?>>
        <?php echo e($slot); ?>

    </button>
<?php else: ?>
    <a href="<?php echo e($href); ?>" <?php echo e($attributes->merge(['class' => 'inline-flex items-center px-4 py-2 rounded-md font-semibold text-xs uppercase tracking-widest disabled:opacity-25 transition ease-in-out duration-150 ' . $classes])); ?>>
        <?php echo e($slot); ?>

    </a>
<?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH F:\gerenciar-app\Gerenciar\resources\views/components/button.blade.php ENDPATH**/ ?>