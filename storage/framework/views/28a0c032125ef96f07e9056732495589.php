...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['title', 'parent', 'parentName', 'children' => null, 'childrenName']));
...
foreach (array_filter((['title', 'parent', 'parentName', 'children' => null, 'childrenName']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="py-4 px-2 flex flex-wrap items-center justify-between">
    <div class="mb-5 lg:mb-0">
        <h2 class="mb-1 text-left text-2xl font-bold">
            <?php echo e($title); ?>

        </h2>
        <div class="flex items-center">
            <a class="flex items-center text-sm text-gray-500" href="<?php echo e(route('dashboard')); ?>">
                <svg class="h-4 w-4 text-gray-500" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <span class="inline-block mx-4">
                <svg class="h-2 w-2 text-gray-500" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <a class="flex items-center text-sm gap-4" href="<?php echo e($parent); ?>">
            ...
            <!--[if BLOCK]><![endif]--><?php if($children): ?>
                <span class="inline-block mx-4">
                ...
                <a class="flex items-center text-sm" href="<?php echo e(URL::current()); ?>">
                    <!-- Children link icon -->
                    <span><?php echo e($childrenName); ?></span>
                </a>
...
</div><?php /**PATH F:\gerenciar-app\Gerenciar\resources\views/components/theme/breadcrumb.blade.php ENDPATH**/ ?>