...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['isActive' => false, 'title' => '', 'collapsible' => false]));
...
foreach (array_filter((['isActive' => false, 'title' => '', 'collapsible' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icons.empty-circle','data' => ['class' => 'text-gray-600 w-5 h-5','ariaHidden' => 'true']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'text-gray-600 w-5 h-5','aria-hidden' => 'true']); ?>
...
<?php endif; ?>
<?php /**PATH F:\gerenciar-app\Gerenciar\resources\views/components/sidebar/link.blade.php ENDPATH**/ ?>